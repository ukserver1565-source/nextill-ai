...
export const sidebarMenu = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Meta Description Generator", icon: "FileText", path: "/meta-description-generator" },
      ...
      { label: "Content Optimizer", icon: "Zap", path: "/content-optimizer" },
      { label: "SERP Analyzer", icon: "BarChart3", path: "/serp-analyzer" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Competitor Analysis", icon: "Crosshair", path: "/competitor-analysis" },
      { label: "Page Speed Analyzer", icon: "Gauge", path: "/page-speed-analyzer" },
      { label: "Broken Link Checker", icon: "Unlink", path: "/broken-link-checker" },
    ],
  },
  {
    section: "Workspace",
    items: [
      ...
      { label: "Documents", icon: "File", path: "#" },
      { label: "History", icon: "Clock", path: "#" },
      { label: "Favorites", icon: "Star", path: "#" },
      { label: "Templates", icon: "LayoutTemplate", path: "#" },
      { label: "Prompt Library", icon: "BookOpen", path: "#" },
    ],
  },
  {
    section: "Account",
    items: [
      ...
      { label: "API Keys", icon: "Key", path: "#" },
      { label: "Settings", icon: "Settings", path: "#" },
      { label: "Support", icon: "LifeBuoy", path: "#" },
    ],
  },
]
