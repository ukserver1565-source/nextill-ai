    ...
    >
      ...
      <div className="px-2 mb-1 mt-1">
        <button
          onClick={onToggle}
          className={cn(
            "w-full flex items-center gap-3 px-3 py-2 rounded-lg text-muted hover:text-foreground hover:bg-card transition-colors",
            ...
            return (
              <div key={section.key} className="space-y-0.5">
                {!collapsed && section.title && (
                  <div className="px-3 py-1 text-[10px] font-semibold uppercase tracking-widest text-muted">
                    {section.title}
                  </div>
                )}
        ...
        <div className="px-3 py-3 border-t border-white/[0.04] space-y-2">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-[10px] text-muted mb-3">Unlock premium features and more credits</p>
