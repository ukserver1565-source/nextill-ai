  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-muted mb-6">Something went wrong in the dashboard. Please try again.</p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/[0.06] text-muted text-sm hover:text-foreground transition-all">
