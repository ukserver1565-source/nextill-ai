...
export default function NewProjectPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <Link href="/dashboard/projects" className="inline-flex items-center gap-2 h-9 rounded-lg px-3.5 text-xs sm:text-sm font-medium bg-card/80 backdrop-blur-xl border border-border text-muted hover:text-foreground hover:bg-card hover:border-muted hover:-translate-y-0.5 transition-all duration-200 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40">
