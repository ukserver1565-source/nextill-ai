...
// All tools — 3 live workflows + coming soon
const allTools = [
  // LIVE WORKFLOWS (clickable — real API-backed tools)
  ...
  // COMING SOON — AI Content Tools (need additional API setup)
  { name: "AI Writer", slug: "ai-writer", icon: FileText, color: "from-gray-500 to-slate-600", desc: "Generate SEO-optimized articles on any topic with AI.", features: ["Custom tone & audience", "Keyword optimization", "Structured output"], category: "content", live: false },
  { name: "AI Humanizer", slug: "ai-humanizer", icon: Edit, color: "from-gray-500 to-slate-600", desc: "Make AI-generated content sound natural and human-written.", features: ["AI detection bypass", "Natural flow", "Preserve meaning"], category: "content", live: false },
  { name: "Article Rewriter", slug: "article-rewriter", icon: Edit, color: "from-gray-500 to-slate-600", desc: "Rewrite and rephrase content while keeping the original meaning.", features: ["Paraphrasing", "Tone adjustment", "Plagiarism prevention"], category: "content", live: false },

  // COMING SOON — SEO Tools
  { name: "SEO Title Generator", slug: "seo-title-generator", icon: Award, color: "from-gray-500 to-slate-600", desc: "Generate optimized meta titles for better search rankings.", features: ["Keyword inclusion", "Character limit", "CTR optimization"], category: "seo", live: false },
  { name: "Meta Description Generator", slug: "meta-description-generator", icon: FileType, color: "from-gray-500 to-slate-600", desc: "Create compelling meta descriptions that boost click-through rates.", features: ["Engaging copy", "Keyword placement", "Length optimized"], category: "seo", live: false },
  { name: "Content Brief", slug: "content-brief", icon: FileType, color: "from-gray-500 to-slate-600", desc: "Generate comprehensive content briefs for writers.", features: ["Topic coverage", "Keyword suggestions", "Structure outline"], category: "content", live: false },
  { name: "Topical Map", slug: "topical-map", icon: Layers, color: "from-gray-500 to-slate-600", desc: "Build topical authority maps for your content strategy.", features: ["Topic clusters", "Pillar pages", "Content gaps"], category: "seo", live: false },
  { name: "FAQ Generator", slug: "faq-generator", icon: MessageSquare, color: "from-gray-500 to-slate-600", desc: "Generate FAQ sections with schema markup for rich snippets.", features: ["Schema-ready", "Natural questions", "SEO optimized"], category: "seo", live: false },
  { name: "Schema Generator", slug: "schema-generator", icon: Layers, color: "from-gray-500 to-slate-600", desc: "Generate JSON-LD structured data for any page.", features: ["Multiple types", "Valid JSON-LD", "Google compliant"], category: "seo", live: false },
  { name: "Grammar Checker", slug: "grammar-checker", icon: Edit, color: "from-gray-500 to-slate-600", desc: "Check and fix grammar, spelling, and punctuation errors.", features: ["Grammar rules", "Style suggestions", "Readability"], category: "content", live: false },
  { name: "Summarizer", slug: "summarizer", icon: FileText, color: "from-gray-500 to-slate-600", desc: "Condense long articles into key takeaways.", features: ["Key points", "Custom length", "Multiple formats"], category: "content", live: false },
  { name: "Translator", slug: "translator", icon: Globe, color: "from-gray-500 to-slate-600", desc: "Translate content between languages with AI.", features: ["Multi-language", "Context-aware", "Natural output"], category: "content", live: false },
  { name: "Internal Link Generator", slug: "internal-link-generator", icon: Layers, color: "from-gray-500 to-slate-600", desc: "Suggest internal linking opportunities for your content.", features: ["Anchor text suggestions", "Relevant pages", "SEO boost"], category: "seo", live: false },
  { name: "Sitemap Generator", slug: "sitemap-generator", icon: Layers, color: "from-gray-500 to-slate-600", desc: "Generate XML sitemaps for your website.", features: ["Auto-discovery", "Priority settings", "Last-modified dates"], category: "seo", live: false },
  { name: "Robots.txt Generator", slug: "robots-txt-generator", icon: FileType, color: "from-gray-500 to-slate-600", desc: "Create optimized robots.txt files for search engines.", features: ["Crawl directives", "Sitemap reference", "Bot blocking"], category: "seo", live: false },
