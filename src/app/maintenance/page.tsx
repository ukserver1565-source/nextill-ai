    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        <div className="liquid-glass-card rounded-2xl p-8 sm:p-10">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-br from-[#6D5EF5] to-[#8B5CF6] text-foreground text-sm font-medium hover:opacity-90 transition-opacity"
          >
            Return Home
          </Link>
        </div>
